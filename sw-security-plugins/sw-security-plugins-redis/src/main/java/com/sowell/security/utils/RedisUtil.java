...
public final class RedisUtil {
     ...
     * @return 结果
     */
    public static boolean hashSet(String key, String hashKey, Object hashValue) {
        try {
     ...
     * @return 结果
     */
    public static boolean hashSet(String key, String hashKey, Object hashValue, long timeout) {
        try {
            redisTemplate.opsForHash().put(key, hashKey, hashValue);
            expire(key, timeout);
            return true;
     ...
     * @return 结果
     */
    public static boolean hashSet(String key, Map<String, Object> map, long timeout) {
        try {
            redisTemplate.opsForHash().putAll(key, map);
            expire(key, timeout);
            return true;
     ...
     */
    public static Long hashDel(String key, Object... hashKeys) {
     ...
     * @param hashKey hash键
     */
    public static Boolean hashExists(String key, String hashKey) {
        if (key == null || hashKey == null) {
            throw new IllegalArgumentException(ILLEGAL_ARGUMENT_MESSAGE);
        }
     ...
     * @return 成功数量
     */
    public static Long setAdd(String key, long timeout, Object... values) {
        if (key == null || values == null || values.length <= 0) {
            throw new IllegalArgumentException(ILLEGAL_ARGUMENT_MESSAGE);
        }
     ...
     * @return 结果
     */
    public static Boolean setExists(String key, Object value) {
        try {
     ...
     * @return 插入数量
     */
    public static Long listSet(String key, Object value, boolean isLeft) {
        try {
            if (isLeft) {
     ...
     * @return 插入数量
     */
    public static Long listSet(String key, Object value, Long timeout, boolean isLeft) {
     ...
     * @return 插入数量
     */
    public static Long listSet(String key, List<Object> values, boolean isLeft) {
        try {
            if (isLeft) {
     ...
     * @return 插入数量
     */
    public static Long listSet(String key, List<Object> values, Long timeout, boolean isLeft) {
