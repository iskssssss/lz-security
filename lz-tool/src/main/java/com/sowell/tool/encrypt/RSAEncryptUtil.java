...
import com.sowell.tool.encrypt.model.SwKeyPair;
...
public class RSAEncryptUtil {
	 ...
	 */
	public static String encrypt(String str, String key, boolean isPublicKey) throws Exception {
		return encrypt(str.getBytes(StandardCharsets.UTF_8), key, isPublicKey);
	}
	/**
	 * RSA加密
	 *
	 ...
	 * @throws Exception 加密过程中的异常信息
	 */
	public static String encrypt(byte[] bytes, String key, boolean isPublicKey) throws Exception {
		byte[] decoded = Base64Util.decode(key);
		if (isPublicKey) {
			RSAPublicKey pubKey = (RSAPublicKey) KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(decoded));
			return encrypt(bytes, pubKey);
		}
		RSAPrivateKey priKey = (RSAPrivateKey) KeyFactory.getInstance("RSA").generatePrivate(new PKCS8EncodedKeySpec(decoded));
		return encrypt(bytes, priKey);
	}
	/**
	 * RSA解密
	 *
	...
	public static String encrypt(String str, RSAPublicKey pubKey) throws Exception {
		return encrypt(str.getBytes(StandardCharsets.UTF_8), pubKey);
	}
	/**
	 * RSA公钥加密
	 *
	 ...
	 * @throws Exception 加密过程中的异常信息
	 */
	public static String encrypt(byte[] bytes, RSAPublicKey pubKey) throws Exception {
	 ...
	 * @throws Exception 加密过程中的异常信息
	 */
	public static String encrypt(String str, RSAPrivateKey priKey) throws Exception {
		return encrypt(str.getBytes(StandardCharsets.UTF_8), priKey);
	}
	/**
	 * RSA私钥加密
	 *
	 ...
	 * @throws Exception 加密过程中的异常信息
	 */
	public static String encrypt(byte[] bytes, RSAPrivateKey priKey) throws Exception {
		Cipher cipher = Cipher.getInstance("RSA");
