...
import cn.lz.tool.http.model.HeadersInfoModel;
import cn.lz.tool.http.model.HttpRequest;
...
public class HttpUtil {
	...
	// post 相关请求
	public static HttpRequest postReHttpRequest(String requestUrl, HeadersInfoModel headersInfoModel, String contentType, Object data) {
	...
	public static HttpRequest postForJsonReHttpRequest(String requestUrl, HeadersInfoModel headersInfoModel, Object body) {
		return postReHttpRequest(requestUrl, headersInfoModel, MediaType.APPLICATION_JSON_VALUE, body);
	}
	...
	public static HttpRequest postForFormReHttpRequest(String requestUrl, HeadersInfoModel headersInfoModel, Map<String, Object> form) {
		return postReHttpRequest(requestUrl, headersInfoModel, MediaType.APPLICATION_FORM_URLENCODED_VALUE, form);
	}
