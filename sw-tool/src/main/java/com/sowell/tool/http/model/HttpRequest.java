...
public class HttpRequest {
	...
	public HttpRequest contentType(ContentTypeEnum contentTypeEnum) {
		this.contentTypeEnum = contentTypeEnum;
		this.headers.setContentType(contentTypeEnum.name);
		return this;
	}

	public HttpRequest form(Map<String, Object> form) {
		this.form = new HashMap<>(4);
		if (this.contentTypeEnum == null) {
			this.contentTypeEnum = ContentTypeEnum.FORM;
		}
